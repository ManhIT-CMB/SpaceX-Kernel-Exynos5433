...
#define pr_fmt(fmt) "IPv6 Route: " fmt
...
{
    pr_warn("%s: set expires %s\n", __func__, (rt->rt6i_flags & RTF_EXPIRES) ? "true" : "false");
    
	if (rt->rt6i_flags & RTF_EXPIRES) {
    pr_warn("%s: jiffies %lu\n", __func__, jiffies);
    pr_warn("%s: expires %lu\n", __func__, rt->dst.expires);
				   ...
				   bool *do_rr)
{
    ...
    pr_warn("%s: check expired\n", __func__);
	if (rt6_check_expired(rt))
		goto out;

	m = rt6_score_route(rt, oif, strict);
	pr_warn("%s: rt6 score route %d\n", __func__, m);
...
int ip6_route_add(struct fib6_config *cfg)
{
    ...
    pr_warn("%s: cfg->fc_flags & RTF_EXPIRES %s\n", __func__, (cfg->fc_flags & RTF_EXPIRES) ? "true" : "false");
			 ...
			 int prefix, int nowait, unsigned int flags)
{
	...
	u32 table;
    pr_warn("%s: \n", __func__);
    pr_warn("%s: rt->rt6i_flags %s\n", __func__, (rt->rt6i_flags) ? "true" : "false");
    ...
    pr_warn("%s: rt->dst.expires %s\n", __func__, (rt->rt6i_flags) ? "true" : "false");
    pr_warn("%s: jiffies %lu\n", __func__, jiffies);
    pr_warn("%s: rt->dst.expires %lu\n", __func__, rt->dst.expires);
    pr_warn("%s: rt->dst.expires - jiffies %lu\n", __func__, rt->dst.expires - jiffies);
