...
sed -i -e '/ui_print("~~~~~~~~~ SpaceX Kernel for/c\ui_print("~~~~~~~~~ SpaceX Kernel for Galaxy Note 4 ~~~~~~~~~");' Output/META-INF/com/google/android/updater-script

sed -i -e '/by ManhIT ~~~~~~~~~~~~~~~");/c\ui_print("~~~~~~~~~~~~~~~ N910S/L/K - by ManhIT ~~~~~~~~~~~~~~~");' Output/META-INF/com/google/android/updater-script

sed -i -e '/package_extract_file("boot.img/c\package_extract_file("boot.img", "/dev/block/mmcblk0p9");' Output/META-INF/com/google/android/updater-script
...
if [ -f "zImage" ]; then
	./mkbootimg --base 0x10000000 --kernel zImage --ramdisk_offset 0x01000000 --tags_offset 0x00000100 --pagesize 2048 --ramdisk ramdisk.cpio.gz --dt dt.img -o boot.img
	echo "zImage"
else
...
rm -rf arch/arm/boot/Image.gz-dtb
